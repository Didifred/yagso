...
you declare it once in the manifest generated by the `generate` command, 
and yagso recursively handles `configure`, `commit`, and `push` commands including for nested submodules.

Additionally a Bill Of Material can be generated.
